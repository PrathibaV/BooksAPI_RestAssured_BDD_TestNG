...
public class GetOrderSteps {
	...
	public void user_creates_get_request_for_retrieving_all_the_orders_with_valid_request_details_from_for(
			String sheetName, String scenario) {
	...
	public void user_receives_and_with_response_body_containing_all_orders_details(int expectedStatusCode,
	...
	public void user_creates_get_request_for_retrieving_an_order_with_valid_request_details_from_for(String sheetName,
			String scenario) {
		context.getRequestBodySetup().readTestDataFromExcel(sheetName);
		context.getRequestBodySetup().orderRequestBodySetup(scenario);
		context.getSpecificationBuilder().requestBuilder(scenario);
